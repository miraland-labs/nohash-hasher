...
///
/// ```
/// use miraland_nohash_hasher::IntMap;
///
...
///
/// ```
/// use miraland_nohash_hasher::IntSet;
///
...
///
/// ```
/// use miraland_nohash_hasher::BuildNoHashHasher;
...
///
/// ```
/// use miraland_nohash_hasher::NoHashHasher;
...
/// }
///
/// impl miraland_nohash_hasher::IsEnabled for SomeType {}
///
/// let mut m = miraland_nohash_hasher::IntMap::default();
///
